const { bold, blue, yellow, grey } = require("../ansi");
const { getInstallCommandByDist } = require("../osys");
...
module.exports = () => {
  ...
  if (process.platform != "win32") {
    ...
    console.log("Install command:\t", yellow(bold(getInstallCommandByDist())));
    console.log(
      "Update command:\t\t",
      yellow(bold(getInstallCommandByDist(true)))
    );
