...
module.exports = async (nexssArgs) => {
  ...
  if (cliArgs._[1] === 'help' && await exists(`${NEXSS_PACKAGES_PATH}/${PARAM0}/README.md`)) {
  ...
  if (startWithSpecialChar(PARAM0) || await exists(`${PARAM0}`) || is('url', PARAM0)) {
    ...
    cliArgs._.unshift('start', `${PARAM0}`)
    PARAM0 = 'start'
  } else if (await exists(`${NEXSS_PACKAGES_PATH}/${packageName}`)) {
