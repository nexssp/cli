...
if (startWithSpecialChar(PARAM0) || myExistsSync(`${PARAM0}`) || is('url', PARAM0)) {
  ...
  if (cliArgs._[1] === 'help' && fs.existsSync(`${NEXSS_PACKAGES_PATH}/${packageName}/README.md`)) {
    const helpContent = fs.readFileSync(`${NEXSS_PACKAGES_PATH}/${packageName}/README.md`)
