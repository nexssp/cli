...
NOTE: **C**, **Java**, **Kotlin**, **Haskell**, **VBScript**, **Windows Scripting Hosts**, **PureData** need some manual adjustments to make to work (languages related).
...
[New **Innovative** and **Evolutionary** _Programming_ Tool](https://www.youtube.com/watch?v=eCxKYMtALDU)  
