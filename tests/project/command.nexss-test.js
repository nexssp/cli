...
const t = {
  ...
  nexsstests: [
    ...
    },
    {
      ...
      params: ['nexss cmd init', process.platform === 'win32' ? 'Volume in' : '_nexss.yml'],
    },
    {
      title: 'Check command is already in the project',
      params: ['nexss cmd add init nexss Id', `Command 'init' is already in the config`],
    },
    {
      title: 'List commands',
      params: ['nexss cmd list', /init.*(dir|ls)/],
    },
  ],
}
